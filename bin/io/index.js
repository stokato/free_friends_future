...
module.exports.listen = function(server, callback) {
  ...
  (function () {
    ...
    let bots1 = [];
    let bots2 = [];
    let room1 = [262409138, 3461, 132310277, 46084870,  232674140];
    let room2 = [231935573, 16067593, 10523063, 97131075, 52617075];
    ...
    for(let b = 0; b < 5; b++) {
      ...
      clientS.emit('init', {
        ...
        country : countries[b],
        city : cities[b],
        vid : room1[b].toString(),
        auth_key : md5('4853914' + '_' + room1[b].toString() + '_' + '06G0eKuPliE1M4mHQU3S')
      });
    ...
    function initB(clientS, isFirst) {
      ...
      clientS.on('change_room', onInitB);
      ...
      clientS.emit('init', {
        ...
        city : cities[count],
        vid : room2[count].toString(),
        auth_key : md5('4853914' + '_' + room2[count].toString() + '_' + '06G0eKuPliE1M4mHQU3S')
      });
    }
    ...
    function onInitB() {
      ...
      if(count < bots2.length) {
        initB(bots2[count], false);
      }
    }
