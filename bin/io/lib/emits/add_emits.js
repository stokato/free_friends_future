...
var addTorFriend        = require('../profile/add_to_friends'),
    ...
    addTrackFree        = require('../player/add_track_free'),
    getFreeTrackState   = require('../player/get_free_track_state'),
...
module.exports = function(socket) {
  ...
  var emitList = [
    ...
    { emit : constants.IO_ADD_TRECK_FREE,         handler : addTrackFree },
    { emit : constants.IO_GET_FREE_TRACK_STATE,   handler : getFreeTrackState },
