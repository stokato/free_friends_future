...
var addTorFriend        = require('../profile/add_to_friends'),
    ...
    addQuestion         = require('./add_question'),
    delQuestion         = require('./delete_question'),
    showQuestions       = require('./show_all_questions'),
    deleteAllQuestions  = require('./delete_all_questions'),
